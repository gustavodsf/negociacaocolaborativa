  ...
  return (
    <>
      ...
      <div className="flex h-screen w-screen flex-col items-center justify-center gap-2 bg-colabGray p-2">
        ...
        <section className="flex w-full flex-row items-start justify-start">
          <div>
            <Link
        ...
        <section className="mt-5 p-1">
          <div className="text-justify text-xl text-colabDarkGreen">
            Essa plataforma é parte integrante de uma pesquisa de doutorado
            PPGI/UFRJ sobre comportamentos interacionais em ambientes virtuais.
            Participando desse experimento você estará colaborando com a
            ciência.
          </div>
          <Link
            href="/termo"
        ...
        <div className="relative flex flex-row items-center justify-center bg-star-2">
          ...
          <Link
            className="absolute left-1/2 top-1/2 w-[8rem] -translate-x-1/2 -translate-y-1/2  transform"
            href="/signin"
          >
            <SendGAEvent
            ...
            >
              <Image src="/bt_login.png" width={200} height={50} alt="phone" />
            </SendGAEvent>
          </Link>
        </div>
