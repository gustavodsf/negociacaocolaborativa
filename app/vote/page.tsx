...
export default async function Perspectiva() {
  return (
    <>
      <SignOut />
      <div className="flex min-h-screen w-screen flex-col items-center justify-center bg-colabBlue">
        <div className="flex h-[8rem] w-[90%] flex-row items-center justify-start rounded-s-lg bg-star-2">
        ...
        <div className="flex h-[8rem] w-[90%] flex-row items-center justify-end bg-star">
          <Link
            href="/perspectiva"
