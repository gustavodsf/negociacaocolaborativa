...
export default async function Termo() {
  return (
    <>
      <SignOut />
      <div className="flex min-h-screen w-screen flex-col items-center justify-center bg-colabGray text-black">
        ...
        <main className="p-4 text-justify">
          ...
          <p>
            ...
            participantes. Mas caso em alguma dessas vivências ocorram incômodos
            a participação poderá ser interrompida sem a necessidade de
            explicações.
          </p>
          <p>
          ...
          <p>
            ...
            consentimento em qualquer fase da pesquisa, seja antes ou depois da
            coleta dos dados, independente do motivo e sem nenhum prejuízo. O/A
            Sr(a) não terá nenhuma despesa e também não receberá nenhuma
            remuneração referente a esta pesquisa.{" "}
          </p>
          <p>
            <b>Os resultados da pesquisa</b> serão analisados e publicados, mas
            a sua identidade não será divulgada, uma vez que será guardada em
            sigilo.
          </p>
          <p>
